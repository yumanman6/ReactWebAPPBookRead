...
// import { Ellipsis } from '@taoyage/react-mobile-ui';
...
import { Space, Ellipsis } from '@/base';
...
const DetailBookInfo: React.FC = React.memo(() => {
    ...
    return <div className={styles.bookInfo}>
        <Space gap={px2rem(12)}>
            ...
            <Space direction="vertical" justify='center' gap={px2rem(10)}>
                ...
                <div className={styles.category}>{data!.categoryName} / {data!.minorCate}</div>
