...
import Catefory from '@/assets/images/category.png';
import Finish from '@/assets/images/finish.png';
import Rank from '@/assets/images/rank.png';
import Recommend from '@/assets/images/recommend.png';

import styles from '@/pages/home/components/navbar/index.module.scss';
    ...
    return <div className={styles.navbar}>
        ...
        <div className={styles.item}>
            <Link to="/category" className={styles.icon}>
                <img src={Catefory} alt='catefory' width={"100%"}/>
            </Link>
